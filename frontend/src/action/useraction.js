...
export const registermobile = (userData) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_USER_NO, payload: error.response?.data?.message || error.message })
...
export const getuser = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_USER, payload: error.response?.data?.message || error.message })
...
export const otpverifie = (otp) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_VERIFY_OTP, payload: Error.response?.data?.message || Error.message })
...
export const resendotp = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_RESEND_OTP, payload: Error.response?.data?.message || Error.message })
...
export const updateuser = (userdata) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_UPDATE_USER, payload: Error.response?.data?.message || Error.message })
...
export const updatedetailsuser = (userdata, id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_UPDATE_DETAILS_USER, payload: Error.response?.data?.message || Error.message })
...
export const logout = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_LOGOUT, payload: Error.response?.data?.message || Error.message })
